...
const external = id => id.startsWith('hamber/');
		...
		output: [
			{
				file: `index.mjs`,
				format: 'esm',
				paths: id => id.startsWith('hamber/') && `${id.replace('hamber', '.')}/index.mjs`
			},
			{
				file: `index.js`,
				format: 'cjs',
				paths: id => id.startsWith('hamber/') && `${id.replace('hamber', '.')}/index.js`
			}
		],
		external,
		plugins: [ts_plugin]
