---
title: <hamber:options>
---

The `<hamber:options>` element allows you to specify compiler options.
...
Add this to the top of the `Todo.hamber` file:

```html
<hamber:options immutable={true}/>
```

> You can shorten this to `<hamber:options immutable/>` if you prefer.
