...
export async function test({ assert, css,  js }) {
	...
	const match = js.code.match(/\tappend_styles\(target, "hamber-.{6}", "(.*?)(?:\\n\/\*# sourceMappingURL=data:(.*?);charset=(.*?);base64,(.*?) \*\/)?"\);\n/);
	...
	const sourcefile = 'input.hamber';
	[
		// TODO: get line and col num from input.hamber rather than hardcoding here
		[css, '--keep-me', 13, 2],
