...
export const component_filepath = 'src/input.hamber';

export const component_file_basename = 'input.hamber';

// as output by external tool for src/external_code.css (relative to src/input.hamber)
