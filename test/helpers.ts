...
export function loadHamber(test: boolean = false) {
...
export const hamber = loadHamber();
...
export function showOutput(cwd, options = {}, compile = hamber.compile) {
