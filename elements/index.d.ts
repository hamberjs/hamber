// Type definitions for Hamber HTML, based on JSX React 18 typings
...
// Note: We also allow `null` as a valid value because Hamber treats this the same as `undefined`
...
export interface HTMLAttributes<T extends EventTarget> extends AriaAttributes, DOMAttributes<T> {
	...
	// HamberKit
	'data-hamberkit-keepfocus'?: true | '' | 'off' | undefined | null;
	'data-hamberkit-noscroll'?: true | '' | 'off' | undefined | null;
	'data-hamberkit-preload-code'?: true | '' | 'eager' | 'viewport' | 'hover' | 'tap' | 'off' | undefined | null;
	'data-hamberkit-preload-data'?: true | '' | 'hover' | 'tap' | 'off' | undefined | null;
	'data-hamberkit-reload'?: true | '' | 'off' | undefined | null;
	'data-hamberkit-replacestate'?: true | '' | 'off' | undefined | null;
}
...
export interface HTMLMediaAttributes<T extends HTMLMediaElement> extends HTMLAttributes<T> {
	...
	readonly 'bind:buffered'?: HamberMediaTimeRange[] | undefined | null;
	readonly 'bind:played'?: HamberMediaTimeRange[] | undefined | null;
	readonly 'bind:seekable'?: HamberMediaTimeRange[] | undefined | null;
...
export interface HamberMediaTimeRange {
	start: number;
	end: number;
}

export interface HamberDocumentAttributes extends HTMLAttributes<Document> {
...
export interface HamberWindowAttributes extends HTMLAttributes<Window> {
	...
	// HamberKit
	'on:hamberkit:start'?: EventHandler<CustomEvent, Window> | undefined | null;
	'on:hamberkit:navigation-start'?: EventHandler<CustomEvent, Window> | undefined | null;
	'on:hamberkit:navigation-end'?: EventHandler<CustomEvent, Window> | undefined | null;
...
export interface HamberHTMLElements {
	...
	// Hamber specific
	'hamber:window': HamberWindowAttributes;
	'hamber:document': HamberDocumentAttributes;
	'hamber:body': HTMLAttributes<HTMLElement>;
	'hamber:fragment': { slot?: string };
	'hamber:options': { [name: string]: any };
	'hamber:head': { [name: string]: any };
